...
## [1.33.0](https://github.com/okashiina/career-ops-id/compare/career-ops-v1.32.0...career-ops-v1.33.0) (2026-09-05)


### Features

* add /calibrate — check evaluation scores against real outcomes ([#3315](https://github.com/okashiina/career-ops-id/issues/3315)) ([4934985](https://github.com/okashiina/career-ops-id/commit/493498572b54c8fed6081281a1190690c01e3f55))
* **anti-fabrication:** tier the Source-of-Truth boundary and add story-provenance-check ([#2947](https://github.com/okashiina/career-ops-id/issues/2947)) ([498dd11](https://github.com/okashiina/career-ops-id/commit/498dd112eb6fa35333aa6c00cef3f8cbce6944d0))
* **application-answers:** parse a rendered section back into a snapshot ([3313515](https://github.com/okashiina/career-ops-id/commit/331351566605ba68c8115c2a99a00290edcb4a68))
* **application-answers:** read the evaluation's Block H draft answers ([778d5bf](https://github.com/okashiina/career-ops-id/commit/778d5bf15ceccbffab13284b7e5752d68aafd44e))
* **apply:** recover previous answers through --read --strict at the CLI seam ([75d6b2c](https://github.com/okashiina/career-ops-id/commit/75d6b2c64315a0820b4a78b254b1c649f3386aa3))
* **artifacts:** ATS form copy-paste plain-text exporter ([#2887](https://github.com/okashiina/career-ops-id/issues/2887)) ([9f79f09](https://github.com/okashiina/career-ops-id/commit/9f79f0921ee0ad2a62b55ab63456057a43831168))
* **batch:** native Node.js batch evaluator for Gemini ([#1650](https://github.com/okashiina/career-ops-id/issues/1650)) ([153414f](https://github.com/okashiina/career-ops-id/commit/153414fd2ae5293b8d1276b70a5f6bff5c5f42f4))
* clean-markers — audit/strip hidden Unicode from generated text outputs ([5fde72f](https://github.com/okashiina/career-ops-id/commit/5fde72f80094c17a3539ecfc34b391c545b682a4))
* **cli:** add help flags to check-liveness ([#2576](https://github.com/okashiina/career-ops-id/issues/2576)) ([4f5934b](https://github.com/okashiina/career-ops-id/commit/4f5934b9152098f2e6bfc66d1ca57fced9d6a07e))
* **cli:** application-artifacts.mjs honours --help ([#2774](https://github.com/okashiina/career-ops-id/issues/2774)) ([c265217](https://github.com/okashiina/career-ops-id/commit/c265217791abf606ee206d37f12ccb687e5c1739))
* **community:** PR adoption ladder for quiet PRs ([c86841b](https://github.com/okashiina/career-ops-id/commit/c86841b87eb4e7f6cbdfcf3bc76672d9b7af8fb8))
* **community:** the Hired Wall, a verifiable ledger of people hired with career-ops ([#3372](https://github.com/okashiina/career-ops-id/issues/3372)) ([542491f](https://github.com/okashiina/career-ops-id/commit/542491fb65811331057987e6dc2734783a070464))
* **company-history:** emit no-response-friction signal per RFC [#1506](https://github.com/okashiina/career-ops-id/issues/1506) schema v1 ([#2787](https://github.com/okashiina/career-ops-id/issues/2787)) ([a74237e](https://github.com/okashiina/career-ops-id/commit/a74237e1c59cfeeffe55e1552d08c350e13002cf))
* **contacts:** linkedin-join.mjs — warm-intro finder from a LinkedIn connections export ([ba1a3dd](https://github.com/okashiina/career-ops-id/commit/ba1a3dd0b6630198b86bedad4ff642d88dc69ecb))
* **cv:** add "text" output_format — tailored markdown CV, no PDF ([#3342](https://github.com/okashiina/career-ops-id/issues/3342)) ([13de717](https://github.com/okashiina/career-ops-id/commit/13de7175b176742573f31ca8221fa46acc3a92da))
* **cv:** add optional Interests section to the HTML CV template ([2e7f1df](https://github.com/okashiina/career-ops-id/commit/2e7f1dfcc8a1082f9ab6a4e7c2a8ca9d86f1feab))
* **cv:** ATS-friendliness check — score a generated CV for parseability ([#2064](https://github.com/okashiina/career-ops-id/issues/2064)) ([6d4e4c7](https://github.com/okashiina/career-ops-id/commit/6d4e4c75b1a60a2e907c648e667dea4d4d2b2a9d))
* **cv:** make Work Experience an optional section ([#2504](https://github.com/okashiina/career-ops-id/issues/2504)) ([74dc716](https://github.com/okashiina/career-ops-id/commit/74dc71688d5d715aa975aa11b91a236eef662b19))
* **cv:** optional url support for projects in HTML and LaTeX ([93e256c](https://github.com/okashiina/career-ops-id/commit/93e256c416ced0127f22c8c4ae0302a6d7724a6f))
* **dashboard:** add Stats analytics view with score quality & seniority mix charts ([#2960](https://github.com/okashiina/career-ops-id/issues/2960)) ([9f0c3c3](https://github.com/okashiina/career-ops-id/commit/9f0c3c39f203e29fb742749aef642e122ff8f822))
* **detect-reposts:** skip multi-employer aggregator boards, and say why ([d6ac988](https://github.com/okashiina/career-ops-id/commit/d6ac988c6655c64f2fcb1170a4561640562b624c))
* **discard:** add discard-log analytics and tuning summary ([#3443](https://github.com/okashiina/career-ops-id/issues/3443)) ([8827f40](https://github.com/okashiina/career-ops-id/commit/8827f4064bf6afe3e8922ec0b99ef74e74c7c99a)), closes [#3392](https://github.com/okashiina/career-ops-id/issues/3392)
* **discover-ats:** probe the long-tail ATS vendors, not just the big three ([2d6f188](https://github.com/okashiina/career-ops-id/commit/2d6f188c3a7ba4ac19c08fe98aa7bc558803018b))
* **doctor:** detect personalization files still carrying template content ([#2691](https://github.com/okashiina/career-ops-id/issues/2691)) ([0cdd935](https://github.com/okashiina/career-ops-id/commit/0cdd935c0d8a71a58121a625e2c18f5a2b86d8f0))
* **doctor:** emit the Gemini Node 20+ verdict instead of leaving it in prose ([#3032](https://github.com/okashiina/career-ops-id/issues/3032)) ([e98bc6b](https://github.com/okashiina/career-ops-id/commit/e98bc6ba9bb29ac625256b38ee548bbd588e0985))
* external data directory via CAREER_OPS_ROOT ([#524](https://github.com/okashiina/career-ops-id/issues/524)) — lands [#1444](https://github.com/okashiina/career-ops-id/issues/1444) ([9159ec6](https://github.com/okashiina/career-ops-id/commit/9159ec6b34cdd1a3226d03c10d6f34c370175e56))
* **followups:** export withFollowupsLock so other writers can share the lock ([fba3bb2](https://github.com/okashiina/career-ops-id/commit/fba3bb2029af81c0193adf7b6cb0adcc0cec840b))
* **hired-wall:** a quiet chevron with the exact remainder says the strip continues ([87e3188](https://github.com/okashiina/career-ops-id/commit/87e3188712ff5dda72013bb6ceffd9ca333d5bd7))
* **hired-wall:** anonymous cards carry sector · location, mirroring the credited-card hierarchy ([9f226e0](https://github.com/okashiina/career-ops-id/commit/9f226e00bf4c98cae8ad30a070ecec1b15372e37))
* **hired-wall:** the audit line speaks to the person mid-search ([c74dfc3](https://github.com/okashiina/career-ops-id/commit/c74dfc32a83e1c36aa3e264f887dc97efea6b0be))
* **hired-wall:** the badge is the title — self-identifying label, own share line, tighter audit line ([7280a48](https://github.com/okashiina/career-ops-id/commit/7280a48731f337563435c756e2ec0754b5115d4c))
* **hired-wall:** verified-hires framing, one CTA line, anonymous silhouette, months parsing ([fb8d6a5](https://github.com/okashiina/career-ops-id/commit/fb8d6a5acae19cffb53239b0f486a8407d8b00a7))
* **local:** preserve Indonesia job board fallbacks ([8b4d72f](https://github.com/okashiina/career-ops-id/commit/8b4d72fbeb2e1974df9c46dfdbe245de4e4e66f8))
* **negotiation:** ROI-based salary-negotiation talking points from verified achievements ([#2950](https://github.com/okashiina/career-ops-id/issues/2950)) ([03b440f](https://github.com/okashiina/career-ops-id/commit/03b440f15104f1d7545fb8a0b316038f563ba2f0))
...
* **oferta:** AI-screening disclosure signal — Block G Signal 15 ([#2892](https://github.com/okashiina/career-ops-id/issues/2892)) ([537b687](https://github.com/okashiina/career-ops-id/commit/537b687a4bda9ec4f783d8fd8afda5b2f110c7b9))
* **outcome:** add --clean-output to archive-then-remove tailored CVs ([#2653](https://github.com/okashiina/career-ops-id/issues/2653)) ([6ab969d](https://github.com/okashiina/career-ops-id/commit/6ab969dade42de66b5b32badcb2dd5cca2ea6b00))
* **pdf:** batch render path reusing one Chromium across N CVs ([#2747](https://github.com/okashiina/career-ops-id/issues/2747)) ([7bb5c32](https://github.com/okashiina/career-ops-id/commit/7bb5c3279baad31a4215988576d0a6e99350e774))
* **pdf:** declare CV section order in config/profile.yml ([#2533](https://github.com/okashiina/career-ops-id/issues/2533)) ([c90b139](https://github.com/okashiina/career-ops-id/commit/c90b13975c7e0ff3c724744608652929678e88a0))
* **plugin:** add h1b-sponsor for DOL sponsorship history on US roles ([#2635](https://github.com/okashiina/career-ops-id/issues/2635)) ([11ae621](https://github.com/okashiina/career-ops-id/commit/11ae621cc505a21d835abc751fa0e2ac8ac9959d))
* **plugins:** register career-ops-plugin-xquik (X hiring posts via Xquik, BYO-key) ([88b325c](https://github.com/okashiina/career-ops-id/commit/88b325c13026c14ab926398f5c7d451ce62a6cd5))
* **portals:** add Wellfound search queries to the example template ([12db45e](https://github.com/okashiina/career-ops-id/commit/12db45eb8b252894832cfeec1e42a97d21c508f1))
* **portals:** profession-agnostic examples in portals.example.yml ([b8614f8](https://github.com/okashiina/career-ops-id/commit/b8614f802a67bf6e7d2fcc402435c14464e5c005))
* **providers/getonbrd:** scan multiple categories per entry ([#3330](https://github.com/okashiina/career-ops-id/issues/3330)) ([2cc140a](https://github.com/okashiina/career-ops-id/commit/2cc140a7a86d99ea7e005339295bb825770dce76))
* **providers:** add Built In aggregator provider ([#3645](https://github.com/okashiina/career-ops-id/issues/3645)) ([291c301](https://github.com/okashiina/career-ops-id/commit/291c301051f54936dd14d65200a1fd06db6c2989))
...
* **providers:** add Garena careers provider ([#3567](https://github.com/okashiina/career-ops-id/issues/3567)) ([d88cfe1](https://github.com/okashiina/career-ops-id/commit/d88cfe160cfc1637fe5b5562726726d00a020974))
* **providers:** add ITviec provider — first Vietnamese job source ([#230](https://github.com/okashiina/career-ops-id/issues/230)) ([ecc9bdc](https://github.com/okashiina/career-ops-id/commit/ecc9bdc3f20dc1e5036146ec684b38986dbb8ca6))
* **providers:** add jobbankca, Canada's federal Job Bank ([7e9feb4](https://github.com/okashiina/career-ops-id/commit/7e9feb4a43b26e0b63aea66425195b7f85062dbd))
* **providers:** add Torre opportunity-search provider ([#3328](https://github.com/okashiina/career-ops-id/issues/3328)) ([086c75a](https://github.com/okashiina/career-ops-id/commit/086c75a4c3b4a032b84c1d5bb95b3bc7d0ea3681))
* **providers:** add yourator job board provider ([c664576](https://github.com/okashiina/career-ops-id/commit/c664576dec4185e140518d9bc1fd2beaf299f901))
* **providers:** CareerViet, second Vietnamese job source ([#3378](https://github.com/okashiina/career-ops-id/issues/3378)) ([e3d372b](https://github.com/okashiina/career-ops-id/commit/e3d372b732424100faf39e37edc4a395e1d1dd98))
* **providers:** job.description for recruitee, ashby, and opt-in smartrecruiters ([#3175](https://github.com/okashiina/career-ops-id/issues/3175)) ([83d3ac6](https://github.com/okashiina/career-ops-id/commit/83d3ac6afbd945cd101b319f4af3b885f445134d))
* **providers:** JobsDB Hong Kong via the existing jobstreet provider ([6fa8279](https://github.com/okashiina/career-ops-id/commit/6fa8279797e3b4dc90dfab38dad62359b1d0dc65))
* **providers:** mycareersfuture, Singapore's national job bank ([#230](https://github.com/okashiina/career-ops-id/issues/230)) ([a726f53](https://github.com/okashiina/career-ops-id/commit/a726f538b17f0d6f237295f5429be2fab3f4365d))
* **providers:** senjob — the scanner's first African source, Senegal ([#2962](https://github.com/okashiina/career-ops-id/issues/2962)) ([db9bd6a](https://github.com/okashiina/career-ops-id/commit/db9bd6aefb45c8297184eaa38cd1c1f006cd7ed8))
* publish Indonesia and Asia-Pacific career ops fork ([fcf5892](https://github.com/okashiina/career-ops-id/commit/fcf58927350ff5e2e168fff9fa94b07a8c14ee96))
* **reports:** add reports_to to the Machine Summary schema ([8cf3dac](https://github.com/okashiina/career-ops-id/commit/8cf3dac5a0f7df0e815d9b57d7337ba7ae3eeea9))
* **scan-ats-full:** optional title_filter_full override for the full-board sweep ([#3089](https://github.com/okashiina/career-ops-id/issues/3089)) ([442084c](https://github.com/okashiina/career-ops-id/commit/442084cbd691539e2bff3c14d47f6baf69527f7e))
* **scan:** add a durable machine-readable scan receipt ([#3532](https://github.com/okashiina/career-ops-id/issues/3532)) ([26f47d2](https://github.com/okashiina/career-ops-id/commit/26f47d2972b6a2bcf00c2aa707744691a0f0ec63))
* **scan:** add Hacker News scanner with optional AI enhancement ([f93b6e9](https://github.com/okashiina/career-ops-id/commit/f93b6e9b3baf4122475e1492850591c917951eda))
* **scan:** opt-in anchored keyword matching ([82be449](https://github.com/okashiina/career-ops-id/commit/82be44956a41dcc7c406073902dd2ddcdc0338c8))
* **scan:** remember permanently dead ATS boards ([#2869](https://github.com/okashiina/career-ops-id/issues/2869)) ([bf54f20](https://github.com/okashiina/career-ops-id/commit/bf54f20eaf295808a037cac0c5dec2810798f4e9)), closes [#2840](https://github.com/okashiina/career-ops-id/issues/2840)
* **templates:** add ATS-friendly single-column CV template pack ([c958462](https://github.com/okashiina/career-ops-id/commit/c9584625e860f1f3bc00b93bc202afcf52de3502))
* **templates:** CJK support for the LaTeX/Overleaf CV path via tectonic ([#3554](https://github.com/okashiina/career-ops-id/issues/3554)) ([1b58724](https://github.com/okashiina/career-ops-id/commit/1b5872460bf57cd810807ac33957c2f5104dd61c)), closes [#3553](https://github.com/okashiina/career-ops-id/issues/3553)
* **templates:** discover template packs by name ([#3202](https://github.com/okashiina/career-ops-id/issues/3202)) ([29e72bc](https://github.com/okashiina/career-ops-id/commit/29e72bc41d16db0a66be7bdf0a14b75af020f6f4))
* **templates:** five named CV templates + a contract test for template variants ([#2954](https://github.com/okashiina/career-ops-id/issues/2954)) ([314cbb5](https://github.com/okashiina/career-ops-id/commit/314cbb5f00a5e5e8a5bbcf875948e9f4c9cb8915))
* **title-filter:** a stem: prefix, for the half a plain keyword gives away ([77c7007](https://github.com/okashiina/career-ops-id/commit/77c70077c6273ab65ffbcd6dafb43bd633c19632))
* **titles:** let the mode retire a keyword, not only add one ([#2751](https://github.com/okashiina/career-ops-id/issues/2751)) ([0cb2d70](https://github.com/okashiina/career-ops-id/commit/0cb2d70b0a8f113518db9bc6aff1695ac1c8185c))
* **update:** declare fork-local paths outside the system layer ([#2793](https://github.com/okashiina/career-ops-id/issues/2793)) ([b082ec6](https://github.com/okashiina/career-ops-id/commit/b082ec6a9c4765cebf51d1038ab9a2195caeb434))
* **updater:** require confirmation before installation ([#2866](https://github.com/okashiina/career-ops-id/issues/2866)) ([f33b8e2](https://github.com/okashiina/career-ops-id/commit/f33b8e2dfa88b02b13460332c3d09e152d8e3a7b)), closes [#2865](https://github.com/okashiina/career-ops-id/issues/2865)
* **verify-pipeline:** flag a malformed follow-ups.md instead of reading it as empty ([#2971](https://github.com/okashiina/career-ops-id/issues/2971)) ([a5ffae2](https://github.com/okashiina/career-ops-id/commit/a5ffae2accf300366df24cd9e853475f3d9bf22b))
...
* wire reply-watch into status-log.tsv ([#1582](https://github.com/okashiina/career-ops-id/issues/1582)) ([f88df83](https://github.com/okashiina/career-ops-id/commit/f88df83934503418d77a8cbce4dc5942c5e18bb8))


### Bug Fixes

* **add-entry:** delegate flag validation to shared validateFlags ([3507239](https://github.com/okashiina/career-ops-id/commit/3507239f8fb495025c5d0d7abdcd5b17f7e57490))
* **add-entry:** exact-match dedup keys so a prefix cannot false-positive ([f3ae221](https://github.com/okashiina/career-ops-id/commit/f3ae2215d5239db75e0fdeef0ecab972bec88432))
* **agent-inbox:** lock resolve rewrites so a concurrent add is never dropped ([#3479](https://github.com/okashiina/career-ops-id/issues/3479)) ([e26a8cc](https://github.com/okashiina/career-ops-id/commit/e26a8cc23ca0dc5c4e7d00873347e690e2b6b2e6)), closes [#3478](https://github.com/okashiina/career-ops-id/issues/3478)
* **agent-inbox:** seed the queue under the lock, not before it ([e585853](https://github.com/okashiina/career-ops-id/commit/e585853f60db86abd9802a53e6f3c10862e038e6))
* **analyze-patterns:** stop counting Applied as positive ([#3667](https://github.com/okashiina/career-ops-id/issues/3667)) ([f4df0c6](https://github.com/okashiina/career-ops-id/commit/f4df0c6ab0325ed42403759c7724456eba3b5c9f))
* **archive-posting:** reject mistyped flags via the shared helper ([#2977](https://github.com/okashiina/career-ops-id/issues/2977)) ([84f152c](https://github.com/okashiina/career-ops-id/commit/84f152cbccd4a8b44e86c871a91532af6549aa3f))
* **ashby:** stop retrying a permanent failure, and honour a clamped Retry-After ([#3072](https://github.com/okashiina/career-ops-id/issues/3072)) ([27fcd48](https://github.com/okashiina/career-ops-id/commit/27fcd48e60a3cf34edd97742e0656b2534c2b5af))
* **ashby:** surface remote work model in the location string ([878e068](https://github.com/okashiina/career-ops-id/commit/878e068bd1ba7fe8e0f2ca74909fc89096ca3f48))
* **assessment-log:** reject unknown flags ([#2802](https://github.com/okashiina/career-ops-id/issues/2802)) ([ce56efe](https://github.com/okashiina/career-ops-id/commit/ce56efe8ae6902924256c8257fe8b1b3ab3fdff7))
* **batch-runner:** curl pre-fetch JD file to avoid empty $jd_file fallback ([#2492](https://github.com/okashiina/career-ops-id/issues/2492)) ([46dc0f4](https://github.com/okashiina/career-ops-id/commit/46dc0f4fdbe62783c435a7203700a301a9004f07))
* **batch-runner:** emit the JD word count color-independently ([#3097](https://github.com/okashiina/career-ops-id/issues/3097)) ([6b61dee](https://github.com/okashiina/career-ops-id/commit/6b61dee175bcebedffb88973df3ac87f8b59211a))
* **batch-tailor:** --min-score 4.5 was silently ignored, and the worker's pdf mode path was cwd-relative ([#2961](https://github.com/okashiina/career-ops-id/issues/2961)) ([f306801](https://github.com/okashiina/career-ops-id/commit/f30680152a54db92bf996120f08a91893a51db44))
* **batch:** keep JD word count machine-readable under FORCE_COLOR ([bf9a6ae](https://github.com/okashiina/career-ops-id/commit/bf9a6aec0713cfe067bd913355637924114006dc))
* **browser-extract:** read Workday JDs from the CXS API, and fail loudly on an empty JD ([#3256](https://github.com/okashiina/career-ops-id/issues/3256)) ([55af9fc](https://github.com/okashiina/career-ops-id/commit/55af9fc715eeb50825f3f710774a96a950e65726))
* **build-cv-latex:** numeric year/date scalars are still dropped — [#2641](https://github.com/okashiina/career-ops-id/issues/2641) fixed only the HTML mirror ([#2916](https://github.com/okashiina/career-ops-id/issues/2916)) ([94eb334](https://github.com/okashiina/career-ops-id/commit/94eb334a03a9837f4a98893e431f61b98264b609))
* **build-cv-latex:** render markdown bold in bullets as \textbf ([#3351](https://github.com/okashiina/career-ops-id/issues/3351)) ([f1cc17b](https://github.com/okashiina/career-ops-id/commit/f1cc17bdb7938a29fa64f5fa28ec5bbac43c3ff4))
* **calibrate:** read all 14 outcome spellings outcome.mjs writes ([#3322](https://github.com/okashiina/career-ops-id/issues/3322)) ([9db4458](https://github.com/okashiina/career-ops-id/commit/9db4458b8f9abba9d0f5c994e3b2a766854d0a56))
* **calibrate:** resolve the tracker colmap from the line array, not the header line ([#3496](https://github.com/okashiina/career-ops-id/issues/3496)) ([abaf075](https://github.com/okashiina/career-ops-id/commit/abaf07565ba888d181cf8d1d094610f3c0c3e1f1)), closes [#3495](https://github.com/okashiina/career-ops-id/issues/3495)
* **check-table-freshness:** validate CLI flags and add a usage block ([#2873](https://github.com/okashiina/career-ops-id/issues/2873)) ([a12dd6b](https://github.com/okashiina/career-ops-id/commit/a12dd6b355282f4801cd948f063525605c1545ed)), closes [#2855](https://github.com/okashiina/career-ops-id/issues/2855)
* **classify-tier:** Associate + an academic rank is not entry-level ([#3178](https://github.com/okashiina/career-ops-id/issues/3178)) ([ef347fb](https://github.com/okashiina/career-ops-id/commit/ef347fb26c636a4d7dd84727744f34356311217e))
* **classify-tier:** validate CLI flags and add a usage block ([#2870](https://github.com/okashiina/career-ops-id/issues/2870)) ([010ccc5](https://github.com/okashiina/career-ops-id/commit/010ccc5eb6be486335c2b973a80605cbfc0eaf45))
* **cli:** a one-letter typo returned a false all-clear at exit 0 in 4 reporting CLIs ([#2920](https://github.com/okashiina/career-ops-id/issues/2920)) ([d65d024](https://github.com/okashiina/career-ops-id/commit/d65d0247183a10d115cedbf6dbda83dccf0fa765))
* **cli:** close the missing-operand hole for value-taking flags ([#3087](https://github.com/okashiina/career-ops-id/issues/3087)) ([201aeca](https://github.com/okashiina/career-ops-id/commit/201aeca286784829062430e680089268e66d29e4))
* **cli:** validate browser-extract flags and honour both value forms ([cfe50c3](https://github.com/okashiina/career-ops-id/commit/cfe50c3458377f60754d52f684f25fb8f1a650f4))
* **cli:** validate fix-slugs flags ([c4a0cc2](https://github.com/okashiina/career-ops-id/commit/c4a0cc22306599dd7f238d6e3cf325f332011f12))
* **cli:** validate flag values in detect-reposts via the shared safeIntFlag ([50944e3](https://github.com/okashiina/career-ops-id/commit/50944e35e174410508d3369fed075a2e4ac456ea))
* **consider:** perform GET /jobs CSRF handshake before the POST ([#2764](https://github.com/okashiina/career-ops-id/issues/2764)) ([f058fbe](https://github.com/okashiina/career-ops-id/commit/f058fbeb9babe6447e91af70eb3cac63fe3d5b1f))
* **contacto:** LinkedIn connection-request limit is 200 on free tier, not 300 ([#2951](https://github.com/okashiina/career-ops-id/issues/2951)) ([9c242c5](https://github.com/okashiina/career-ops-id/commit/9c242c575ed0bd4d8e9591a3546b255464303f20))
* **contacto:** stop searching for contacts the mode never uses ([17f5557](https://github.com/okashiina/career-ops-id/commit/17f55577fe315392ca557419bace93d2b2c53ff6))
* **contacts:** add -h/--help and reject unrecognized flags ([#2829](https://github.com/okashiina/career-ops-id/issues/2829)) ([0aa3299](https://github.com/okashiina/career-ops-id/commit/0aa3299b2e4d6a1d1b1d88fb8a52dc688e902afb))
* **cover-letter:** preserve --out subdirectories inside the output root ([2cc0682](https://github.com/okashiina/career-ops-id/commit/2cc068226407ba193e844a72549cc65572216089))
* **coverage:** exclude the local-paths declaration file so a fork can commit it ([280044e](https://github.com/okashiina/career-ops-id/commit/280044e1fe14e9b25f067324bf7a87ba9828649f))
* **cv-sync-check:** resolve prompt paths from CODE_ROOT instead of an undefined projectRoot ([d6df7a2](https://github.com/okashiina/career-ops-id/commit/d6df7a290581d186f46f94969c1b52fa1a68f8aa))
* **cv-sync-check:** stop allowFail from excusing an uncaught crash ([a19da42](https://github.com/okashiina/career-ops-id/commit/a19da42dc6f71c17f52d5b907ea7980429576851))
* **cv,pdf:** address CodeRabbit review feedback for [#2213](https://github.com/okashiina/career-ops-id/issues/2213) ([8c08b76](https://github.com/okashiina/career-ops-id/commit/8c08b765fd8a4a0e77b671d8e4b2fb2c47653888))
* **cv:** an empty Skills section no longer deletes the sections after it ([199b7d6](https://github.com/okashiina/career-ops-id/commit/199b7d68941362134e8ba9ae08d68c1d7c117b08))
* **cv:** block delegated authorship escalation ([#3657](https://github.com/okashiina/career-ops-id/issues/3657)) ([08bdb3f](https://github.com/okashiina/career-ops-id/commit/08bdb3f184f4abf7b355915609a71985d30c1881))
* **cv:** honor Korean profile font theme ([70a062c](https://github.com/okashiina/career-ops-id/commit/70a062cbfc1abe810b747773778feada524315de))
* **cv:** reject CV payloads whose section keys the builders never read ([#3524](https://github.com/okashiina/career-ops-id/issues/3524)) ([9f6efb5](https://github.com/okashiina/career-ops-id/commit/9f6efb5c73d890675c269099fd1b182d3d6ddb42)), closes [#3523](https://github.com/okashiina/career-ops-id/issues/3523)
* **dashboard:** match company slugs at hyphen boundaries so Meta cannot open Metabase's CV ([#3483](https://github.com/okashiina/career-ops-id/issues/3483)) ([f5e2753](https://github.com/okashiina/career-ops-id/commit/f5e27531e866514441bcd6f9e03b56db93b93c91))
* **dashboard:** read job URLs from the tracker before the legacy enrichment tiers ([c124fb6](https://github.com/okashiina/career-ops-id/commit/c124fb668e594f92d78d6ff8d178a48ffa90f908))
* **data-root:** resolve templates/states.yml from the codebase, not the data root ([#3503](https://github.com/okashiina/career-ops-id/issues/3503)) ([be61f60](https://github.com/okashiina/career-ops-id/commit/be61f60be88aed8277cef2f498140c098517e65e))
* **dates:** seven more today-gates resolve in UTC ([2e4458e](https://github.com/okashiina/career-ops-id/commit/2e4458ed8e067fb8af53f167e2324e25ad284c74))
* **dates:** weekly-digest and rejection-latency read the local day, not the UTC day ([c8200cb](https://github.com/okashiina/career-ops-id/commit/c8200cbbd0757fe9ed7594192daac049f443add3))
...
* **detect-reposts:** concurrent openings were reported as reposts ([18ff33d](https://github.com/okashiina/career-ops-id/commit/18ff33d92ad5e2a2b9a9af90b2018977fb845548))
* **doctor:** surface tracked .bak backup files as a warning ([228e7b8](https://github.com/okashiina/career-ops-id/commit/228e7b8078804d82c92f2497ea2ec340b7fc0cae))
* **doctor:** survive a null entry in installed_plugins.json ([0a137a1](https://github.com/okashiina/career-ops-id/commit/0a137a14c936d83a81f537661417e04ada2e37a5))
* **doctor:** validate CLI flags and add a usage block ([#2874](https://github.com/okashiina/career-ops-id/issues/2874)) ([d4c31be](https://github.com/okashiina/career-ops-id/commit/d4c31be403453249abe039c3ebc50cb7e56f7539)), closes [#2856](https://github.com/okashiina/career-ops-id/issues/2856)
* **email:** align fit points with the tailored CV via the pdf-index row ([#3473](https://github.com/okashiina/career-ops-id/issues/3473)) ([d08aac2](https://github.com/okashiina/career-ops-id/commit/d08aac29e33775245f70d1f5b9a781103f40777d)), closes [#3460](https://github.com/okashiina/career-ops-id/issues/3460)
* **fact-gate:** a non-English CV inflating headcount returns 'pass' — say so instead ([#3320](https://github.com/okashiina/career-ops-id/issues/3320)) ([fa13474](https://github.com/okashiina/career-ops-id/commit/fa13474f5a74d3d66af5dfb57f9cdf6f8fadc39c))
* **fact-gate:** count education and training nouns as metrics ([#3646](https://github.com/okashiina/career-ops-id/issues/3646)) ([12b1a4a](https://github.com/okashiina/career-ops-id/commit/12b1a4a2f54cdabfa33faf35519c55e255899155))
* **followup-cadence:** validate CLI flags via the shared helper ([#3196](https://github.com/okashiina/career-ops-id/issues/3196)) ([ec800a2](https://github.com/okashiina/career-ops-id/commit/ec800a2c7539ee394b89eb6d6434a3f2f61de84a))
* **followup:** stop reporting the candidate's own address as a contact to chase ([c0fe77e](https://github.com/okashiina/career-ops-id/commit/c0fe77e2e497552ff1b994a79f9d7d6f9ab182d0))
* **followup:** stop truncating plus-addressed emails at the plus ([9d4817c](https://github.com/okashiina/career-ops-id/commit/9d4817c07f944b352ffba6f68131c10b3902fe82))
* **funnel-velocity:** fold status-log history into calibration rates ([#3494](https://github.com/okashiina/career-ops-id/issues/3494)) ([369db53](https://github.com/okashiina/career-ops-id/commit/369db538ccf4c62eff5de890433a9e00805b6d41)), closes [#3493](https://github.com/okashiina/career-ops-id/issues/3493)
* **funnel-velocity:** validate CLI flags via the shared helper ([b6ebe08](https://github.com/okashiina/career-ops-id/commit/b6ebe08bad2a5609d3a98b064da7761f9d2e6ede))
* **gemini:** resolve encoding mojibake on Windows and route localized modes ([#1443](https://github.com/okashiina/career-ops-id/issues/1443)) ([3f54486](https://github.com/okashiina/career-ops-id/commit/3f54486e540a74ef1a6eca81f2bda9ab59bc7ca4))
* **gfi-claims:** reply when /assign is used outside the claim pool ([f0b24df](https://github.com/okashiina/career-ops-id/commit/f0b24dfa5198d3ecf5c7394ff9777b20872b8950))
* **gitignore:** the tracker's derived SQLite index is unignored outside data/ ([#3468](https://github.com/okashiina/career-ops-id/issues/3468)) ([bc5771a](https://github.com/okashiina/career-ops-id/commit/bc5771a12fab34ce28b66856be54ece6504b6e3a))
* **gmail:** skip page assets so logos stop landing as job leads ([#3649](https://github.com/okashiina/career-ops-id/issues/3649)) ([c172fd8](https://github.com/okashiina/career-ops-id/commit/c172fd8993862f5ad99dfdf6dc67f3cc650d087f))
* **greenhouse:** populate job.description from the boards API content field ([#3175](https://github.com/okashiina/career-ops-id/issues/3175)) ([f1c1c65](https://github.com/okashiina/career-ops-id/commit/f1c1c6540f7f510bf8e7bce9ae9e9f00e75567fe))
* handle quoted angle brackets while stripping HTML tags ([702a2ae](https://github.com/okashiina/career-ops-id/commit/702a2ae4c590f28a140b5fa845818a356b57c22f))
* harden context budget prompt assembly ([#3591](https://github.com/okashiina/career-ops-id/issues/3591)) ([1be498d](https://github.com/okashiina/career-ops-id/commit/1be498d177cf8a52e6f7affe2d00f12baf552394))
* **harness:** make the syntax gate recursive, shared with npm run lint ([43f846c](https://github.com/okashiina/career-ops-id/commit/43f846ca49587a8507af2db5c8af76d7a11ba7b5))
* **hired-share:** suggest outcome.mjs's real syntax in the no-Hired-row error ([4a69583](https://github.com/okashiina/career-ops-id/commit/4a69583146723b5dd753185ae0d0ca029e03534c))
* **hired-wall:** ellipsize single-line card rows instead of clipping at the viewBox ([61dd811](https://github.com/okashiina/career-ops-id/commit/61dd8113a096488933603bc576a47c763b6cf97e))
* **hired-wall:** honor both permission wordings and default public stories to full credit ([f65ba5e](https://github.com/okashiina/career-ops-id/commit/f65ba5ed0a358cd600c621234c284be162f9a670))
* **i18n:** preserve safety guardrails in localized modes ([3afc54d](https://github.com/okashiina/career-ops-id/commit/3afc54d1f7921a0ab99fcb02b5fc383014ec956d))
* **intake:** treat a nonzero version probe as present, not missing ([c1df672](https://github.com/okashiina/career-ops-id/commit/c1df6725eba487be0a2e39f734d5994b1b7082aa))
* **invite-match:** stop extractReqId backtracking quadratically ([#3463](https://github.com/okashiina/career-ops-id/issues/3463)) ([637e7eb](https://github.com/okashiina/career-ops-id/commit/637e7eb718d7ac1a2bb19706b892b07e7f636b78))
* **invite-match:** validate CLI flags and add usage ([#2958](https://github.com/okashiina/career-ops-id/issues/2958)) ([34b1d58](https://github.com/okashiina/career-ops-id/commit/34b1d58ff954b83f7cb797317c1bbc5aaafdacd8))
* **jd-skill-gap:** recognize Traditional and Simplified Chinese requirement headings ([#3631](https://github.com/okashiina/career-ops-id/issues/3631)) ([08e8747](https://github.com/okashiina/career-ops-id/commit/08e8747fe0a77756db54b0f88bd3e8dc45b8c58a))
* **jobbankca:** count raw entries for pagination ([#3249](https://github.com/okashiina/career-ops-id/issues/3249)) ([19b7314](https://github.com/okashiina/career-ops-id/commit/19b7314d06a1a03a2ab3f8bbcafd20b06d83e4c6))
* **liveness:** a dead third-party host must not poison the whole verdict ([1389e6c](https://github.com/okashiina/career-ops-id/commit/1389e6cb6186facf2fc847666d9ae85d2723d568))
* **liveness:** add a LinkedIn rung so LinkedIn postings get a real verdict ([#3179](https://github.com/okashiina/career-ops-id/issues/3179)) ([255bfc9](https://github.com/okashiina/career-ops-id/commit/255bfc940479574da5ab363665b6a64a8dfdeadd))
* **liveness:** read same-origin iframes so embedded postings aren't false negatives ([#2884](https://github.com/okashiina/career-ops-id/issues/2884)) ([bd36aa5](https://github.com/okashiina/career-ops-id/commit/bd36aa5990beac49bc9dd24549fffc6b765c5997))
* **locks:** one recovery judgment, imported by all three copies ([638fdc4](https://github.com/okashiina/career-ops-id/commit/638fdc4edf2dbce2e6e59c998520ce5962a23d47))
* **locks:** share the waiting half of the protocol with the three lock copies ([39f87cd](https://github.com/okashiina/career-ops-id/commit/39f87cd7ad40825649ef930e2103911b88407f51))
* **locks:** the other two copies of the protocol had the same Windows bug ([#3033](https://github.com/okashiina/career-ops-id/issues/3033)) ([1f73f2e](https://github.com/okashiina/career-ops-id/commit/1f73f2eabbbf4376a9103cc1619a98a72682512b))
* **locks:** treat Windows rm/stat contention as contention, not death ([#2984](https://github.com/okashiina/career-ops-id/issues/2984)) ([2743281](https://github.com/okashiina/career-ops-id/commit/27432818d29faf67103714e12f6777bf39239c67))
* **merge-tracker:** --backfill-urls rebuilds unfillable rows to full header width ([#3381](https://github.com/okashiina/career-ops-id/issues/3381)) ([d6435ef](https://github.com/okashiina/career-ops-id/commit/d6435efe6e73b05629b1cddb6f4ba734c5b29191))
* **merge-tracker:** a corporate-suffix variant is the same employer ([#3666](https://github.com/okashiina/career-ops-id/issues/3666)) ([a4f5276](https://github.com/okashiina/career-ops-id/commit/a4f52765f1920c353933984ff5ed71da50bedf36)), closes [#3665](https://github.com/okashiina/career-ops-id/issues/3665)
* **merge-tracker:** don't let an unscoreable (N/A) re-eval overwrite a real score ([#2803](https://github.com/okashiina/career-ops-id/issues/2803)) ([3c66092](https://github.com/okashiina/career-ops-id/commit/3c6609262286a9283923767a736b15e081bf2a9e))
* **merge-tracker:** match inline URL headers so URL dedup activates for doc-style rows ([#2926](https://github.com/okashiina/career-ops-id/issues/2926)) ([c078513](https://github.com/okashiina/career-ops-id/commit/c078513127aa13bd02edb2a2cbadad34da20615b))
* **merge-tracker:** two '?' rows with no Via silently merge, overwriting one ([#3466](https://github.com/okashiina/career-ops-id/issues/3466)) ([8f22538](https://github.com/okashiina/career-ops-id/commit/8f22538a1458ee7fe5ad0da70183facf72361d90)), closes [#3410](https://github.com/okashiina/career-ops-id/issues/3410)
* **merge-tracker:** write rows at the header's actual width on customized trackers ([8668ac1](https://github.com/okashiina/career-ops-id/commit/8668ac1a0d37676a8540be54724333b57240ec6d))
* **oferta:** lead Block B with the decisive columns and freeze their order ([#3660](https://github.com/okashiina/career-ops-id/issues/3660)) ([abc5a89](https://github.com/okashiina/career-ops-id/commit/abc5a893a61b752b1e410d5145c044b82638f0d2))
* **openai-eval:** stream the evaluation call instead of a single buffered response ([#3501](https://github.com/okashiina/career-ops-id/issues/3501)) ([ee6e8f6](https://github.com/okashiina/career-ops-id/commit/ee6e8f63ce6f1a62d64e22a9fb37c28b2a000429))
* **openrouter:** write scan-history and pipeline through the shared locked writers ([#3462](https://github.com/okashiina/career-ops-id/issues/3462)) ([81e27c5](https://github.com/okashiina/career-ops-id/commit/81e27c5e9b6225b73383dea4f9fe464977821123))
* **outcome:** a tracker edit forks the append-only journal, and directory order decides which half counts ([#3325](https://github.com/okashiina/career-ops-id/issues/3325)) ([ba2b409](https://github.com/okashiina/career-ops-id/commit/ba2b409d1dbd55160499f5f1c69731bc5bd8e61d))
* **pdf:** accept the canonical modes/pdf.md tailoring order in validateCvSectionOrder ([#3642](https://github.com/okashiina/career-ops-id/issues/3642)) ([a9c957c](https://github.com/okashiina/career-ops-id/commit/a9c957caedea5dbdc17d165d072dd66d330b42d4))
* **pdf:** enforce workspace boundary in direct renderer ([a4706e3](https://github.com/okashiina/career-ops-id/commit/a4706e3b9f6ef4ce2bc6a470ccfb1e60e56c4c82))
* **pdf:** name both sides when the lexical containment check fires ([#3162](https://github.com/okashiina/career-ops-id/issues/3162)) ([98cc650](https://github.com/okashiina/career-ops-id/commit/98cc6501e739d992e83436b366020cebc1592819))
* **pdf:** name canonicalization failure separately from a real workspace escape ([e4a21ba](https://github.com/okashiina/career-ops-id/commit/e4a21ba91c2dbbd96f01722b516a120cc7d56df2))
* **pdf:** run the CLI when reached through a symlink ([#3170](https://github.com/okashiina/career-ops-id/issues/3170)) ([3c2fa60](https://github.com/okashiina/career-ops-id/commit/3c2fa6083976777bd69ecb24d697d5ebc3551a09))
* **pdf:** run the fact gate before rendering a CV ([#3647](https://github.com/okashiina/career-ops-id/issues/3647)) ([1b299fa](https://github.com/okashiina/career-ops-id/commit/1b299faa659c782d2385c4119191c382a0b01dea))
* **pdf:** stop the batch-evaluate fixture leaking its tracker env ([#3162](https://github.com/okashiina/career-ops-id/issues/3162)) ([328fd38](https://github.com/okashiina/career-ops-id/commit/328fd387df5b7f8f9ede17562c2dd7d932db7247))
* **pipeline-lock:** a vanished lock is not a lock you may delete ([680419f](https://github.com/okashiina/career-ops-id/commit/680419f9d5316c0b8ec07f35fecfaa6c21b73e2b))
* **pipeline-lock:** an unreadable owner stamp is not an ownerless lock ([bb537c6](https://github.com/okashiina/career-ops-id/commit/bb537c630f46174d7dc452c21d5b804f628cb5ff))
* **pipeline-lock:** carry the judged directory's identity to the rm ([7ada146](https://github.com/okashiina/career-ops-id/commit/7ada14663a2e91d9cd927120f9f6e23e14df141f))
* **pipeline-lock:** time out a wedged holder, not an unlucky waiter ([098bad0](https://github.com/okashiina/career-ops-id/commit/098bad01b899c4ce3c3d3946957d654379b9a5c7))
* **pipeline:** serialize browser-backed extraction so workers never share a session ([#2551](https://github.com/okashiina/career-ops-id/issues/2551)) ([3bc0053](https://github.com/okashiina/career-ops-id/commit/3bc0053368f202bb22c83e9422f6b533a5fa9b1d))
* **pipeline:** use browser-first LinkedIn extraction ([e0f0f33](https://github.com/okashiina/career-ops-id/commit/e0f0f33630e713401c907e4123feb7edd070a3c8))
* **plugins:** a YAML typo in plugins.yml no longer destroys the whole config ([#3593](https://github.com/okashiina/career-ops-id/issues/3593)) ([00f185d](https://github.com/okashiina/career-ops-id/commit/00f185d672dd7bf2499f5a3ae7ee7be340493da3)), closes [#3592](https://github.com/okashiina/career-ops-id/issues/3592)
* **plugins:** discover a plugin directory that is symlinked into a plugin root ([b9fe775](https://github.com/okashiina/career-ops-id/commit/b9fe7758af5e75b104be2c82d070e60f482f1dde))
* **plugins:** isolate cmdRun results to the requested plugin id ([#2354](https://github.com/okashiina/career-ops-id/issues/2354)) ([f0044f8](https://github.com/okashiina/career-ops-id/commit/f0044f8c7890bd7069a64a61639a90130c86c67b))
* **plugins:** scale export hook timeout with tracker size ([a8cbb2d](https://github.com/okashiina/career-ops-id/commit/a8cbb2df20ec61227dc5cd50dbeaed2526893b70))
* **portals.example:** drop retired EchoJobs block ([3254ea3](https://github.com/okashiina/career-ops-id/commit/3254ea39d585c609dde826051237529c93ee7691))
* **portals.example:** name the support ROLE, not the whole domain ([d57a243](https://github.com/okashiina/career-ops-id/commit/d57a24371113ef41d5caaf15b58490c84d7a1a44))
* **portals:** block German student and support postings in the example title filter ([6a3dbc2](https://github.com/okashiina/career-ops-id/commit/6a3dbc290d3c1d5805bc40002d2d0010aa876666))
* **portals:** refresh example board URLs after ATS migrations ([44e8a69](https://github.com/okashiina/career-ops-id/commit/44e8a69290cf6e01d91e09c21405df118c4fc66a))
* **portals:** sweep and validate job_boards, not only tracked_companies ([#3448](https://github.com/okashiina/career-ops-id/issues/3448)) ([2c5894e](https://github.com/okashiina/career-ops-id/commit/2c5894e0a4a74146bf04b8c8532e338d45a131ea))
* **process-quality:** three undisclosed employers were reported as disclosed ([#3005](https://github.com/okashiina/career-ops-id/issues/3005)) ([b5acfa5](https://github.com/okashiina/career-ops-id/commit/b5acfa513bc16896f0310affaa835c4a1bb21f04))
* **providers/icims:** fill a missing location from the posting's JSON-LD ([20ec88f](https://github.com/okashiina/career-ops-id/commit/20ec88fdacec63a9a3d29ca3b5ed9c07e33dfaea))
* **providers/lever:** fold categories.allLocations into location ([e3260d8](https://github.com/okashiina/career-ops-id/commit/e3260d8a4aeca5cae8d486d1f3dbd61a0a583a1f))
* **providers:** a16z treats a non-positive total_pages as absent, not as one page ([002307f](https://github.com/okashiina/career-ops-id/commit/002307f6ade85e805a486e6a9847b1014f1bb1ad))
* **providers:** decode HTML entities in titles before matching so encoded ampersands stop dropping jobs ([#2923](https://github.com/okashiina/career-ops-id/issues/2923)) ([37f4c11](https://github.com/okashiina/career-ops-id/commit/37f4c11b4ad5e3aca94aa389453806b3a6210535))
* **providers:** make themuse resilient to per-page fetch failures ([#2682](https://github.com/okashiina/career-ops-id/issues/2682)) ([a83800f](https://github.com/okashiina/career-ops-id/commit/a83800feac3c15017365c6d6b6acb69509757f20))
* **providers:** raise inter-page pacing to 250 ms on the eight providers still at 150 ([#3095](https://github.com/okashiina/career-ops-id/issues/3095)) ([3416f64](https://github.com/okashiina/career-ops-id/commit/3416f64237c9ad01f4d24861cd791c37d3345a2a))
* **providers:** retire echojobs, feed is gone behind bot protection ([2c42733](https://github.com/okashiina/career-ops-id/commit/2c42733852db7cf6e779547e6b10df9bb7a3e7fc))
* **providers:** route softgarden and radancy through the shared entity decoder ([#2487](https://github.com/okashiina/career-ops-id/issues/2487)) ([96b1de6](https://github.com/okashiina/career-ops-id/commit/96b1de6806dd2630f4c26b19cf37c6ca98638d07))
* **providers:** senjob was the fifth private entity decoder, and the weakest — it emitted C0 controls ([aa21e92](https://github.com/okashiina/career-ops-id/commit/aa21e9296e2c1c54b82887641ed7b843c3e3cf37))
* **providers:** total_pages outranks a short page in the a16z sweep loop ([#2547](https://github.com/okashiina/career-ops-id/issues/2547)) ([e34be83](https://github.com/okashiina/career-ops-id/commit/e34be83bd409c0e240aacfd4c31241472953707a))
* **providers:** validate resolved addresses before connecting (DNS rebinding guard) ([#3096](https://github.com/okashiina/career-ops-id/issues/3096)) ([d8d4d94](https://github.com/okashiina/career-ops-id/commit/d8d4d94a550d18aea45c137a3afbd6475586b8d6))
* **reconcile-pipeline:** validate CLI flags via the shared helper ([b4384a7](https://github.com/okashiina/career-ops-id/commit/b4384a797556250a2e73a23e40b3a0a8e13f332a))
* **rename-sync:** migrate 5 vulnerable call sites to renameSyncWithRetry ([#3046](https://github.com/okashiina/career-ops-id/issues/3046)) ([213c281](https://github.com/okashiina/career-ops-id/commit/213c2815a53560cc9764295c3a298a4e53d7f7fa))
* **reply-matcher:** a partial role-word match must be a whole word ([#3535](https://github.com/okashiina/career-ops-id/issues/3535)) ([90d311f](https://github.com/okashiina/career-ops-id/commit/90d311f25684ed66180825d679ce78c38adb62e7))
* **reply-matcher:** the '?' unknown-employer placeholder matched everything ([#3001](https://github.com/okashiina/career-ops-id/issues/3001)) ([86e653d](https://github.com/okashiina/career-ops-id/commit/86e653d5b08bbf81781c0f84b6c567dbe79e571f))
* **reserve-report-num:** handle --help/-h explicitly ([#3569](https://github.com/okashiina/career-ops-id/issues/3569)) ([84693b4](https://github.com/okashiina/career-ops-id/commit/84693b407326e0ae65274e2eebaf613de890f515))
* resolve skill paths from project root ([#3332](https://github.com/okashiina/career-ops-id/issues/3332)) ([68bee94](https://github.com/okashiina/career-ops-id/commit/68bee943ccd7e502807c38c5998f060cbb71cdea))
* **role-matcher:** a level stated on both sides of a title must agree ([#3651](https://github.com/okashiina/career-ops-id/issues/3651)) ([dfeb2fc](https://github.com/okashiina/career-ops-id/commit/dfeb2fccd4a0c2a27e666969823150b61ee91159))
* **salary-gap:** decide which separator is the decimal point before deleting either ([17f44f9](https://github.com/okashiina/career-ops-id/commit/17f44f977fbdd1e62a7f32241f8dc0f21aba410c))
* **salary-gap:** treat a period as thousands grouping, not a decimal point ([#3174](https://github.com/okashiina/career-ops-id/issues/3174)) ([b8e5bcb](https://github.com/okashiina/career-ops-id/commit/b8e5bcb3d81ae68b3dd8055e71c2c248ebd21867))
* **scaffolder:** restore the published npm package name ([5e2bf5b](https://github.com/okashiina/career-ops-id/commit/5e2bf5b9726097413294f3acffb3a2025ae9570f))
* **scan-ats-full:** cap single-host ATS sweeps at their own concurrency ([#2839](https://github.com/okashiina/career-ops-id/issues/2839)) ([5ef0676](https://github.com/okashiina/career-ops-id/commit/5ef0676a3b304e48325031070358d547d65b70de))
* **scan-ats-full:** collapse a Workday requisition served under several sites of one tenant ([#3446](https://github.com/okashiina/career-ops-id/issues/3446)) ([5c26e4a](https://github.com/okashiina/career-ops-id/commit/5c26e4af43b89a11f79caa7592a1a2e03caeb55d))
* **scan-ats-full:** send the progress counter to stderr under --json ([fa6a84f](https://github.com/okashiina/career-ops-id/commit/fa6a84f48d949bd75ff5d94839494a1ef7a70a20))
* **scan:** add block_hard tier so always_allow cannot discard an explicit block ([9073af7](https://github.com/okashiina/career-ops-id/commit/9073af7042d209533eb6375731647d89ab3bde94))
* **scan:** do not block Dublin OH as Ireland ([#3633](https://github.com/okashiina/career-ops-id/issues/3633)) ([56429bf](https://github.com/okashiina/career-ops-id/commit/56429bfaa07ec695581500fbfd12184e9ba43723))
* **scan:** Level 1 runs Playwright sequentially, matching the shared-session rule ([77eebc9](https://github.com/okashiina/career-ops-id/commit/77eebc95877d993fddca4c30aeee7eeff439bc65))
* **scan:** locate the URL anywhere in a pipeline.md entry ([#2605](https://github.com/okashiina/career-ops-id/issues/2605)) ([c0413e3](https://github.com/okashiina/career-ops-id/commit/c0413e3ce374b2e6be628a46f9b28422e26d3e85))
* **scan:** opt-in word:/stem: anchoring for content_filter keywords ([ce3ac16](https://github.com/okashiina/career-ops-id/commit/ce3ac16bdd2438f5f4eea05ec8f03f8305e7f36c))
* **scan:** resolve scanner user data against the data root, not the cwd ([#3511](https://github.com/okashiina/career-ops-id/issues/3511)) ([7d7b0f9](https://github.com/okashiina/career-ops-id/commit/7d7b0f97d447a2d1c72b7b3a24c9c99ebc9a5d7a)), closes [#3510](https://github.com/okashiina/career-ops-id/issues/3510)
* **scan:** three scanners stamp first_seen in UTC, the reader measures it in local ([#3070](https://github.com/okashiina/career-ops-id/issues/3070)) ([cc241ea](https://github.com/okashiina/career-ops-id/commit/cc241eab47dc40e6ecb7e3c5a9b25884a7ff61ae))
* **set-status:** a transition into Applied seeds the follow-up from set-status itself ([#3470](https://github.com/okashiina/career-ops-id/issues/3470)) ([9312da7](https://github.com/okashiina/career-ops-id/commit/9312da7ee49e24f496dcb81adec86530de644051)), closes [#3459](https://github.com/okashiina/career-ops-id/issues/3459)
* **set-status:** rejects today's date east of UTC, logs tomorrow's west of it ([2461b3b](https://github.com/okashiina/career-ops-id/commit/2461b3b979fcd6d361a8be555f1cb9fc96728251))
* **set-status:** resolve --report links from the Notes cell on customized layouts ([#3075](https://github.com/okashiina/career-ops-id/issues/3075)) ([ae70a41](https://github.com/okashiina/career-ops-id/commit/ae70a410bc77552b6a52ad15ab1ecb78f41f2fa3))
* **skill-extract:** recognize marketing/GTM skills and stop reporting tracked employers as gaps ([#3537](https://github.com/okashiina/career-ops-id/issues/3537)) ([f8de04e](https://github.com/okashiina/career-ops-id/commit/f8de04e20444fbd80d034c0d37fd3d47a82b0501))
* **stats,calibrate:** ledger-aware funnel + calibration ([#1428](https://github.com/okashiina/career-ops-id/issues/1428), [#1724](https://github.com/okashiina/career-ops-id/issues/1724)) ([34e5547](https://github.com/okashiina/career-ops-id/commit/34e5547ada30afac4b536abe2de84bb04dadc019))
* **stats,calibrate:** reject malformed status ledger rows ([#3350](https://github.com/okashiina/career-ops-id/issues/3350)) ([0f645d2](https://github.com/okashiina/career-ops-id/commit/0f645d2fd60f37348587f1626861da650f4887a4))
* **stats:** stop reporting a neighbouring counter when scan-runs.tsv drifts ([5eb71d5](https://github.com/okashiina/career-ops-id/commit/5eb71d5db82ad50de20f35e14823c33bef9fcc4f))
* **stats:** validate CLI flags via the shared helper ([#3003](https://github.com/okashiina/career-ops-id/issues/3003)) ([9002602](https://github.com/okashiina/career-ops-id/commit/9002602032ab660e692ecd09b4dc75a84959865a))
* **story-provenance:** make the context matcher script-aware, not ASCII-only ([2d7521e](https://github.com/okashiina/career-ops-id/commit/2d7521e9d753a6ccceadec9599d98a6c4e55811b))
* **templates:** extend profile font_family override to ja and zh blocks ([5291cc7](https://github.com/okashiina/career-ops-id/commit/5291cc79755caf249a73313b949b6763ef16e260))
* **templates:** honor profile font_family in the Traditional Chinese CV block ([#3525](https://github.com/okashiina/career-ops-id/issues/3525)) ([f0d2082](https://github.com/okashiina/career-ops-id/commit/f0d2082a4f2b7668e825016bccb18e219b3c982d)), closes [#3154](https://github.com/okashiina/career-ops-id/issues/3154)
* **templates:** keep a project's tech line with the description above it ([676efcd](https://github.com/okashiina/career-ops-id/commit/676efcd32a26aa83d635098608851b0b2c986945))
* **templates:** keep CJK fallback fonts active for ja, zh-CN and ko ([#3531](https://github.com/okashiina/career-ops-id/issues/3531)) ([f3b7c60](https://github.com/okashiina/career-ops-id/commit/f3b7c60f18ff25e8122a3cea6d1e22c4005acae3))
* **test-all:** tolerate Windows EPERM on fixture cleanup so a green run stays green ([b21bf47](https://github.com/okashiina/career-ops-id/commit/b21bf4705eee48f69ca64d9d80fae87c28574671))
* **test:** handle terminal user-layer wildcards ([741f676](https://github.com/okashiina/career-ops-id/commit/741f676089c43fecf1435425a8a9f58d99566401))
* **tests:** answer gitignore probes that cross a user-layer symlink ([#3598](https://github.com/okashiina/career-ops-id/issues/3598)) ([aa8832f](https://github.com/okashiina/career-ops-id/commit/aa8832f2c1795f2ae9e802d9eb5d20fb807f3e00))
* **tests:** assert flag echo by substring, not by unescaped RegExp ([6c2220f](https://github.com/okashiina/career-ops-id/commit/6c2220fc6114cba3df74e9f1cb743afe60fef833))
* **tests:** assert the flag echo with includes instead of an unescaped RegExp ([743622d](https://github.com/okashiina/career-ops-id/commit/743622d382c415761172ec0c5b304a62bf3ae70c))
* **tests:** guard the web/ mirror import behind existsSync ([e09e3cd](https://github.com/okashiina/career-ops-id/commit/e09e3cd5cc98b42dd6040bfa7731b308cc4c6e8e))
* **tests:** keep the end of a failing script's output, not just the head ([#3035](https://github.com/okashiina/career-ops-id/issues/3035)) ([a0f4622](https://github.com/okashiina/career-ops-id/commit/a0f46223372a01730b74e16e7c0f89c26d1c41ea))
* **tests:** make the suite symlink-aware for externalized user layers ([7d97d14](https://github.com/okashiina/career-ops-id/commit/7d97d147da0c0cc542a50dcbe174d57d71d196be))
* **tests:** scope the profile pin and move the last hand-registered suites ([0bcd0fa](https://github.com/okashiina/career-ops-id/commit/0bcd0fae30165b8c13d6b7fd6d28eda8e2fe367a))
* **tests:** stop the photo suite writing cv-preview.html into the user's data root ([#3599](https://github.com/okashiina/career-ops-id/issues/3599)) ([f1b7a8e](https://github.com/okashiina/career-ops-id/commit/f1b7a8e582c385254539488fb7c82224a333a49a))
* **tracker:** reject malformed application IDs instead of coercing them ([#3485](https://github.com/okashiina/career-ops-id/issues/3485)) ([c68a7d4](https://github.com/okashiina/career-ops-id/commit/c68a7d46b6fe1e5869b8316b0814cc4c0675cd95))
* **tracker:** resolve templates/states.yml from the module, not the cwd ([#3509](https://github.com/okashiina/career-ops-id/issues/3509)) ([08b7f31](https://github.com/okashiina/career-ops-id/commit/08b7f317b596fa010d06cd28f8a9b53799c02fd1)), closes [#3508](https://github.com/okashiina/career-ops-id/issues/3508)
* **tracker:** resolve the derived index path at call time, not at import ([#3507](https://github.com/okashiina/career-ops-id/issues/3507)) ([9bd4445](https://github.com/okashiina/career-ops-id/commit/9bd4445e25e1308aefe44e6f04c1750c373edaff))
* **tracker:** sort the applications table by # ascending on write ([#3515](https://github.com/okashiina/career-ops-id/issues/3515)) ([372cd04](https://github.com/okashiina/career-ops-id/commit/372cd043b35e8d07cd522fec955a65252c0906db))
* **tracker:** treat Windows rename contention as contention, not death ([#2777](https://github.com/okashiina/career-ops-id/issues/2777)) ([474ffc4](https://github.com/okashiina/career-ops-id/commit/474ffc4f4c5f05929863a9d9f8528d32c0375c1a))
* **triage:** fall back to Playwright when WebFetch finds nothing ([#3571](https://github.com/okashiina/career-ops-id/issues/3571)) ([10b93a5](https://github.com/okashiina/career-ops-id/commit/10b93a5f6e4444332243fefaef65b8b153835fc1))
* **trust-validator:** a company with an accent in its name is flagged for being on its own domain ([5adc39f](https://github.com/okashiina/career-ops-id/commit/5adc39fad7dfcb391642e74b7909942b10b462fe))
* **update-system:** apply() cannot commit when a path it stages is ignored or never tracked ([ae6909f](https://github.com/okashiina/career-ops-id/commit/ae6909f718c9316a0d1424379e1688f438a07706))
* **update-system:** never prune a file the update just preserved, or an asset it references ([c8afb5d](https://github.com/okashiina/career-ops-id/commit/c8afb5d041a5d10d4634c4d28abd20dfe8efaf58))
* **update-system:** refuse to run when the install is not its own git toplevel ([aecae53](https://github.com/okashiina/career-ops-id/commit/aecae537fe7cf52b1da92ff05aaa5976cf85d18f))
* **update:** commit the index so file-mode changes are not dropped ([#2629](https://github.com/okashiina/career-ops-id/issues/2629)) ([4b1d66b](https://github.com/okashiina/career-ops-id/commit/4b1d66b22249506442906e673405bcfed7c58a57))
* **update:** drop the duplicate prune loop that deleted stale files twice ([#3208](https://github.com/okashiina/career-ops-id/issues/3208)) ([e50fbad](https://github.com/okashiina/career-ops-id/commit/e50fbad8ca5bc7f91ef568dc72c56c31b7285d52))
* **update:** point the updater at the repository's new home ([9063495](https://github.com/okashiina/career-ops-id/commit/9063495036e253668e42d6bbbd4234e750b25782))
* **updater:** back up self-bootstrap edits before checkout ([#3474](https://github.com/okashiina/career-ops-id/issues/3474)) ([203c90b](https://github.com/okashiina/career-ops-id/commit/203c90b79e632209e3a55068499f8ca5cbea489e))
* **updater:** detect tree drift and prune retired system files ([#2630](https://github.com/okashiina/career-ops-id/issues/2630), [#2532](https://github.com/okashiina/career-ops-id/issues/2532)) ([6242527](https://github.com/okashiina/career-ops-id/commit/624252731d34c78773efbced2ff256e04c1c4c93))
* **update:** reconcile .gitignore on apply so new ignore rules reach existing installs ([#2857](https://github.com/okashiina/career-ops-id/issues/2857)) ([2728cd0](https://github.com/okashiina/career-ops-id/commit/2728cd0d40f0f640856e898aadc6999d05a8d2ba))
* **update:** refuse non-canonical paths in the local declaration file ([764f20f](https://github.com/okashiina/career-ops-id/commit/764f20f87df9a8c413b74d82626cc4c9c83209d6))
* **updater:** parse git status paths from untrimmed output ([5091202](https://github.com/okashiina/career-ops-id/commit/50912023e92a144f3b058e4b2e45c90441c74672))
* **updater:** parse git status with -z so quoted paths and renames match real files ([79152e7](https://github.com/okashiina/career-ops-id/commit/79152e732ecddf587d6f4011903139b9fd06c612))
* **updater:** parse the SYSTEM_PATHS array instead of scraping it with a regex ([#3099](https://github.com/okashiina/career-ops-id/issues/3099)) ([61f8850](https://github.com/okashiina/career-ops-id/commit/61f8850d14e828567a3cc7f7a665e9e440c4eed0))
* **updater:** scope commits to shipped files ([#3688](https://github.com/okashiina/career-ops-id/issues/3688)) ([455bf37](https://github.com/okashiina/career-ops-id/commit/455bf375a84508a955acd58819392fa9f7a07bd0))
* **updater:** settle same-version SHA mismatch on tree content, not SHAs ([b00619d](https://github.com/okashiina/career-ops-id/commit/b00619d6b562879f44798e9fa70cf67ecd1a696f))
* **update:** stop misreading upstream's own content as a local edit ([#3094](https://github.com/okashiina/career-ops-id/issues/3094)) ([50c5400](https://github.com/okashiina/career-ops-id/commit/50c54008c078b339e4da4f4427b5a253e28c95a1))
* **upskill:** validate CLI flags via the shared helper ([841390c](https://github.com/okashiina/career-ops-id/commit/841390c9c49ef5417f3e7504cbc67561ffd503b1))
* **velocity:** count a web-written transition as an observation ([#2898](https://github.com/okashiina/career-ops-id/issues/2898)) ([2e36380](https://github.com/okashiina/career-ops-id/commit/2e363807429322c6f660b011d4b56b3222e3c3cb))
* **verify-cv-facts:** bind a count to the nearest metric noun, not the farthest ([#3465](https://github.com/okashiina/career-ops-id/issues/3465)) ([53620d3](https://github.com/okashiina/career-ops-id/commit/53620d3bfaf10652bb8d746c73758ad5cda8fe5c))
* **verify-cv-facts:** catch fabricated headcounts outside software ([5cdb445](https://github.com/okashiina/career-ops-id/commit/5cdb44516d9882614748bd9c4382351693ac1b04))
* **verify-pipeline:** recover a report number from a link target written with backslashes ([8177808](https://github.com/okashiina/career-ops-id/commit/81778084cff5341a62026a936ccf616821a524de))
* **verify-portals:** --add probes slugs that cannot exist for an accented company name ([8bd65eb](https://github.com/okashiina/career-ops-id/commit/8bd65ebeb9750ef20d503cfd8e281ecf90f5353c))
* **verify-portals:** decode the HTML entities a board page serves in its title ([eb20257](https://github.com/okashiina/career-ops-id/commit/eb20257394f6164b7795dc3426412c11e7a0ed65))
* **verify-portals:** stop the slug repair path adopting a stranger's board ([d3b830d](https://github.com/okashiina/career-ops-id/commit/d3b830d18c46f727dd07158828e9e11a421f9183))
* **verify:** a check that could not run is a failure, not a warning ([5ae4337](https://github.com/okashiina/career-ops-id/commit/5ae433780e5db2ad43a9365ae560bf3ae7a4f204))
* **voice-dna:** make voice-dna.md private via the template pattern ([#2952](https://github.com/okashiina/career-ops-id/issues/2952)) ([10a9c55](https://github.com/okashiina/career-ops-id/commit/10a9c55147fb1a3ae6a7741f41fad59b68c79722))
...
* **workday:** recover offset-clamped tenants with a facet split ([#3310](https://github.com/okashiina/career-ops-id/issues/3310)) ([e268a5a](https://github.com/okashiina/career-ops-id/commit/e268a5a226b15c8e695db923b85416423490bf65))
* **workday:** resolve a CXS-form URL as the endpoint, not as a careers page ([#3505](https://github.com/okashiina/career-ops-id/issues/3505)) ([0dbe4a9](https://github.com/okashiina/career-ops-id/commit/0dbe4a9129d3c3a5dbaec1c883320b327958f5ca))
* **workspace:** keep artifacts and PDF metadata in the tracker's workspace ([d3dbd63](https://github.com/okashiina/career-ops-id/commit/d3dbd63bf915a9a17efdc055f0a675b6163a1269))
